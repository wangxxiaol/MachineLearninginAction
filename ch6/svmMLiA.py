# -*- coding: utf-8 -*-
"""
Created on Fri Dec  1 11:43:21 2017
...
def kernelTrans(X, A, kTup): #calc the kernel or transform data to a higher dimensional space
    ...
    if kTup[0]=='lin': K = X * A.T   #linear kernel
        ...
        K = exp(K/(-1*float(kTup[1])**2)) #divide in NumPy is element-wise not matrix like Matlab
...
def testRbf(Kl = 1.3):
    ...
    errorCount = 0
    for i in range(m):
        kenelEval = kernelTrans(sVs, datMat[i, :], ('rbf', Kl))
